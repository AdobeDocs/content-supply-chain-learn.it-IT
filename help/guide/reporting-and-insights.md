...
description: Misura le prestazioni dei contenuti nell’intero percorso di clienti, in linea con le metriche aziendali.
...
# Tutorial su reporting e approfondimenti

Misura le prestazioni dei contenuti nell’intero percorso di clienti, in linea con le metriche aziendali.
...
<table>
    <tr style="border: 0;">
      ...
      <td style="align: center">
        <p style="margin: 0"><img alt="Analisi" src="/help/assets/analytics-logo.png" style="width: 42px;height:42px;"></p>
