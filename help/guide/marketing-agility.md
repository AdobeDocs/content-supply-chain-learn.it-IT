---
title: 'Agilità di marketing: possibilità di scalare le risorse non creative'
description: Guarda i tutorial sulla catena di fornitura dei contenuti di Adobe; a volte è possibile soddisfare una richiesta di contenuto senza il trattamento completo del team creativo o dello studio. Adobe mette gli strumenti nelle mani degli esperti di marketing e di altri potenziali creatori di contenuti, in modo che i rapidi accessi alla creazione di varianti e aggiornamenti di contenuti possano essere eseguiti da un gruppo più ampio di persone connesse alla catena di fornitura dei contenuti, aumentando notevolmente la velocità effettiva dei contenuti e il time-to-market.
...
Con gli strumenti Adobe Content Supply Chain a volte è possibile rispondere a una richiesta di contenuto senza il trattamento completo del team creativo/studio. Adobe mette gli strumenti nelle mani degli esperti di marketing e di altri potenziali creatori di contenuti. Questi strumenti consentono di attivare rapidamente la creazione di varianti di contenuto. Gli aggiornamenti possono essere eseguiti da un gruppo più ampio di singoli utenti connessi alla supply chain dei contenuti, aumentando notevolmente la velocità effettiva dei contenuti e il time-to-market.

Adobi di soluzioni utilizzate per l’agilità di marketing:
...
* Genera rapidamente contenuti per campagne di risposta rapida
* Remix dei contenuti esistenti mantenendo il marchio
* Automatizzare la produzione di risorse derivate (dimensioni, canale)
...
<div class="columns is-multiline"><div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Using Smart Crop with AEM Assets Dynamic Media" tabIndex="0">
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/images/smart-crop-feature-video-use.html?lang=it" title="Utilizzo di Smart Crop con AEM Assets Dynamic Medie" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/21519?format=jpeg" alt="Utilizzo di Smart Crop con AEM Assets Dynamic Medie">
        </a>
      </figure>
    </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-social-posters.html" title="Creazione di poster social network con Firefly" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3420533?format=jpeg" alt="Creazione di poster social network con Firefly">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-webinar-poster.html" title="Creazione di poster di webinar con il Firefly" tabindex="-1">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-blog-graphics.html" title="Eseguire facilmente le campagne social" tabindex="-1">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-local-marketing.html" title="Creazione di contenuti di volantino per una campagna di marketing con Firefly" tabindex="-1">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    ...
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          ...
          <p class="is-size-6"><em>Scopri come un team di e-commerce può creare facilmente immagini coinvolgenti per un nuovo set di inventario nel proprio negozio online.</em></p>
      </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/multi-channel-marketing-content.html" title="Consentire ai team di marketing di creare contenuti multicanale" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3424446?format=jpeg" alt="Consentire ai team di marketing di creare contenuti multicanale">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/content-automation/overview.html" title="Panoramica dell’automazione dei contenuti con i servizi Creative Cloud" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/333197?format=jpeg" alt="Panoramica dell’automazione dei contenuti con i servizi Creative Cloud">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
